...
MACHINE_MAP = {
    ...
    "칭량공정": [], 
    "분무건조공정": ["GPCG2"],
    "과립공정": ["P100", "SM100", "P400", "GS400", "SM600", "KM10", "글라트유동층", "구형과립기", "롤러컴팩터"],
...
with st.sidebar:
    ...
    st.markdown("<div style='text-align: center; color: #94a3b8; font-size: 12px; margin-top: 30px; line-height: 1.4;'>Ver 3.08 / Developed by JK / Production Dept.</div>", unsafe_allow_html=True)
